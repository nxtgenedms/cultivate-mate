...
-- ============================================
DROP POLICY IF EXISTS "Authorized users can create instances" ON public.checklist_instances;
DROP POLICY IF EXISTS "Authorized users can update instances" ON public.checklist_instances;
...
-- ============================================
DROP POLICY IF EXISTS "Users can create responses" ON public.checklist_item_responses;
DROP POLICY IF EXISTS "Users can update responses" ON public.checklist_item_responses;
...
-- ============================================
DROP POLICY IF EXISTS "Authorized users can create inventory receipts" ON public.inventory_receipts;
DROP POLICY IF EXISTS "Authorized users can update inventory receipts" ON public.inventory_receipts;
...
-- ============================================
DROP POLICY IF EXISTS "Authorized users can create inventory usage" ON public.inventory_usage;
DROP POLICY IF EXISTS "Authorized users can update inventory usage" ON public.inventory_usage;
...
-- ============================================
DROP POLICY IF EXISTS "Growers can create mortality records" ON public.mortality_discard_records;
DROP POLICY IF EXISTS "Authorized users can update mortality records" ON public.mortality_discard_records;
...
-- ============================================
DROP POLICY IF EXISTS "Authorized users can create SOF03 submissions" ON public.sof03_phase_gate_submissions;
DROP POLICY IF EXISTS "Authorized users can update SOF03 submissions" ON public.sof03_phase_gate_submissions;
