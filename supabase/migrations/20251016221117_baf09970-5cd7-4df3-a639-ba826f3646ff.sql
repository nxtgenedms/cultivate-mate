-- Create function to notify users when tasks need approval
...
DROP TRIGGER IF EXISTS task_approval_notification_trigger ON public.tasks;
CREATE TRIGGER task_approval_notification_trigger
  AFTER UPDATE ON public.tasks
  FOR EACH ROW
  EXECUTE FUNCTION public.notify_task_approval_needed();