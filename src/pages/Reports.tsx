      ...
      <div className="space-y-6">
        ...
        <Tabs defaultValue="batches" className="space-y-4">
          ...
          <TabsContent value="reconciliation" className="space-y-4">
            <Card>
              <CardHeader>
                <CardTitle>Post-Harvest Batch Reconciliation</CardTitle>
                <CardDescription>
                  Timeline view of post-harvest processing stages for each batch
                </CardDescription>
              </CardHeader>
              <CardContent>
                {batchesLoading ? (
                  ...
                  b.current_stage === 'harvest' || 
                  b.current_stage === 'processing_drying' || 
                  b.current_stage === 'packing_storage' ||
                  b.harvest_date
                ).length > 0 ? (
                  <div className="space-y-6">
                    {batches
                      ...
                      .map((batch) => {
                        // Calculate stage durations and progress
                        const stages = [
                          {
                            name: 'Harvest',
                            color: 'hsl(220, 70%, 70%)',
                          ...
                          },
                          {
                            ...
                            duration: batch.no_of_days_drying || 7,
                          },
                          {
                            name: 'Drying',
                            color: 'hsl(45, 75%, 60%)',
                          ...
                          <Card key={batch.id} className="overflow-hidden">
                            <div className="p-4 bg-muted/30 border-b">
                              <div className="flex items-center justify-between">
                                <div>
                                  <h3 className="text-lg font-semibold">{batch.batch_number} - Post-harvest Processing</h3>
                  ...
                  <div className="text-center py-12">
                    <p className="text-muted-foreground">No post-harvest batches found</p>
                    <p className="text-sm text-muted-foreground mt-2">
                      Batches will appear here once they reach harvest stage
                    </p>
                  </div>
                )}
              </CardContent>
